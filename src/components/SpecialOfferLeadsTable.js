...
const data = [
  createData('Cody Uptain', "828-490-3763", "codyuptain27@gmail.com", "5% off sitewide", '12/01/20'),
  createData('Cody Uptain', "828-490-3763", "codyuptain27@gmail.com", "5% off sitewide", '12/01/20'),
  createData('Cody Uptain', "828-490-3763", "codyuptain27@gmail.com", "5% off sitewide", '12/01/20'),
  createData('Cody Uptain', "828-490-3763", "codyuptain27@gmail.com", "5% off sitewide", '12/01/20'),
  createData('Cody Uptain', "828-490-3763", "codyuptain27@gmail.com", "5% off sitewide", '12/01/20'),
...
function SpecialOfferLeadsTable(props) {
  const { classes } = props;
  ...
  return (
    <div className={classes.root}>
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            <TableCell className={classes.tableCell}>Lead Name</TableCell>
            <TableCell numeric className={classes.tableCell}>Phone Number</TableCell>
            <TableCell numeric className={classes.tableCell}>Email</TableCell>
            <TableCell numeric className={classes.tableCell + ' ' + classes.hideMobile}>Offer</TableCell>
...
SpecialOfferLeadsTable.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(SpecialOfferLeadsTable);